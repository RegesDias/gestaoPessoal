...
<header class="main-header">
    <!-- Logo control-sidebar-open -->
<!--    <a href="index.php?pst=<?=$respGet['pst']?>&arq=<?=$respGet['arq']?>&idSecretaria=<?=$respGet['idSecretaria']?>&varq=<?=$respGet['varq']?>&vpst=<?=$respGet['vpst']?>&relat=<?=$respGet['relat']?>&orby=<?=$respGet['orby']?>&pg=1&leftmenu=<?=$lm?>&rightmenu=2" class="logo">
      <span class="logo-mini"><img src="img/logoMenu.png" class="img-rounded"></span>
      <span class="logo-sdgc"><img src="img/logoMenu.png" class="img-rounded"><strong class="fontLogo">SDGC</strong><sub><i>4.0.0</i></sub><sup>A4</sup></span>
    </a>-->
    <?php
