...
<html>
    ...
    <body bgcolor="009CB8">
        ...
        <form action="macaeapp.php" method="post">
...
<?php } ?>
        ...
        <br><br><br><br><b>Busca por Local e Dia Semana</b>
        <form action="macaeapp.php" method="post">
            <select name="idLotacaoSub">
                <?php foreach ($localLista as $el) { ?>
                    <option value="<?= $el[id] ?>"><?= $el[nome] ?></option> 
<?php } ?>
            </select>
            <select name="iddiasemana">
            ...
            <input type="hidden" name='acao' value="BuscalocDS">
            <input type="submit"  value='buscar'>
        </form>
        <br><br><br><br><b>Busca por Nome</b>
        <form action="macaeapp.php" method="post">
