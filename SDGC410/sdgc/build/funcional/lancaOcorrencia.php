...
if ($respGet['acao'] == "lancarOco") {
    ...
    $lancarOco = array(      
                    ...
                    'setorOco' => $respGet['idSetor'],
                    'dias' => $respGet['diasOco'],
                    'obs' => $respGet['ObsOco'],     
                    'idTipoOco' => $respGet['tpOco']        
                       );
        ...
        <div class="box-body">
                ...
                <div class="row">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div onclick="apagarSelect('multiselect_to')">
                                    <?php 
                                        if($respGet['arq'] == 'perfil'){ ?>
                                            <select name="idSetor" <?php if ($lote) { ?> onchange="getAJAX(<?= "'" . $ajurl . "'"; ?>, <?= " '" . $servico . "'"; ?>, this.value, selectServidoresPorSetor)" <?php } ?> size="1" class="form-control select2" id='ocorrencia' style="width: 100%;">
                                            </div>   
                                        ...
                                        if($respGet['arq'] == 'ocorrencia'){?>
                                            
                                    <!-- BOX SECRETARIA E SETOR pARA LANÇAMENTO EM LOTE -->
                                    <div onclick="apagarSelect('multiselect_to')">
                                        <div class="box-body">
                                            <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <select onchange="updateText(this);" name='tpOco'class="form-control select2" id='ocorrencia' style="width: 100%;">
            ...
            <div class="form-group col-sm-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="datetimes" autocomplete=off class="form-control pull-right" /> 
                </div>
            </div>
            <script>
