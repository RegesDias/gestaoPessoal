                    ...
                    <table class="table table-hover">
                        ...
                        foreach (paginaAtual($_SESSION[lotacaoSubVariavel], $respGet[pgSetor]) as $ArrEspp) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-default" onclick="buscaVServidor('selecionarSetor', '<?= $_SESSION[idVariavelDesc] ?>', '<?= $ArrEspp[idLotacaoSub] ?>', '<?= $ArrEspp[nomeLotacaoSub] ?>')" type="button">
                                        <i class="fa fa-search"></i>
                                    </button>
                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary" onclick="fecharEmloteSetor('fecharVariavelSetor', '<?= $_SESSION[idVariavelDesc] ?>', '<?= $ArrEspp[idLotacaoSub] ?>', '<?= $ArrEspp[nomeLotacaoSub] ?>', '<?= $respGet[pgSetor] ?>', '<?= $_SESSION[nomeVariavel] ?>')" type="button">
                                                        Confirmar
                                                    </button>
                                    ...
                                    <div class="modal fade" id="aprovar<?= $id ?>" role="dialog">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary" onclick="acaoEmlote('aprovarVariavelSetor', '<?= $_SESSION[idVariavelDesc]?>', '<?= $ArrEspp[idLotacaoSub] ?>', '<?= $ArrEspp[nomeLotacaoSub] ?>', '<?= $respGet[pgSetor] ?>')" type="button">
                                                        Confirmar
                                                    </button>
                                                    <button type="button" data-dismiss="modal" class="btn btn-default">Cancelar</button>
                                                </div>
                                    ...
                                    <div class="modal fade" id="reprovar<?= $id ?>" role="dialog">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary" onclick="acaoEmlote('negarVariavelSetor', '<?= $_SESSION[idVariavelDesc] ?>', '<?= $ArrEspp[idLotacaoSub] ?>', '<?= $ArrEspp[nomeLotacaoSub] ?>', '<?= $respGet[pgSetor] ?>')" type="button">
                                                        Confirmar
                                                    </button>
                                                    <button type="button" data-dismiss="modal" class="btn btn-default">Cancelar</button>
                                                </div>
                                    ...
                                    <div class="modal fade" id="lancar<?= $id ?>" role="dialog">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary" onclick="acaoEmlote('lançarVariavelSetor', '<?= $_SESSION[idVariavelDesc] ?>', '<?= $ArrEspp[idLotacaoSub] ?>', '<?= $ArrEspp[nomeLotacaoSub] ?>', '<?= $respGet[pgSetor] ?>')" type="button">
                                                        Confirmar
                                                    </button>
                                                    <button type="button" data-dismiss="modal" class="btn btn-default">Cancelar</button>
                                                </div>
...
<!--                                    <button title="Remove todos os lançamentos" type="submit" <?= $disable ?>  class="btn btn-default" data-toggle="modal" data-target="#remover<?= $id ?>"><i class="fa fa-close"></i></button>-->
                                    <div class="modal fade" id="remover<?= $id ?>" role="dialog">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary" onclick="acaoEmlote('excluirVariavelSetor', '<?= $_SESSION[idVariavelDesc] ?>', '<?= $ArrEspp[idLotacaoSub] ?>', '<?= $ArrEspp[nomeLotacaoSub] ?>', '<?= $respGet[pgLotacaoSub] ?>')" type="button">
                                                        Confirmar
                                                    </button>
                                                    <button type="button" data-dismiss="modal" class="btn btn-default">Cancelar</button>
                                                </div>
                                    ...
                                    <button type="button" onclick="imprimirRelatVariaveisServidores('relatFechamentoVariavelSub', '<?= $ArrEspp[idLotacaoSub] ?>', '<?= $_SESSION[idVariavelDesc] ?>', false)" class="btn btn-primary"><i class="fa fa-print"></i></button>
                                </td>
                            </tr>                
    <?php } ?>
                    </table>
